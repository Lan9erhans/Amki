...
public class QuizMenu extends SuperQuizView implements ActionListener {
	...
	public DefaultListModel<runtimeQuiz> rqModel;
...
//		System.out.println(list);
	...
	@Override
	public void doPost1() {
		if(rq.runtimeQuizList.size() != 0 && (rqModel.size() != rq.runtimeQuizList.size())) {
	...
	public void doGet() {
		...
		sf.getContentPane().add(quizHideView.setDao(rq));
		sf.revalidate();
		sf.repaint();
		sf.setVisible(true);
		qf.setVisible(false);
